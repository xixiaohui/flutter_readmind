...
class $BooksTable extends Books with TableInfo<$BooksTable, Book> {
  ...
  late final GeneratedColumn<String> filePath =
      GeneratedColumn<String>('file_path', aliasedName, false,
  ...
  @override
  late final GeneratedColumn<String> fileType =
...
class $BookChaptersTable extends BookChapters
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, bookId, chapterIndex, title, contentPath, wordCount, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $ReadingProgressTable extends ReadingProgress
  ...
  late final GeneratedColumn<double> scrollPosition = GeneratedColumn<double>(
      'scroll_position', aliasedName, true,
  ...
  late final GeneratedColumn<double> progressPercent = GeneratedColumn<double>(
      'progress_percent', aliasedName, true,
      type: DriftSqlType.double, requiredDuringInsert: false);
  ...
  ReadingProgressData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ReadingProgressData(
      ...
      scrollPosition: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}scroll_position']),
...
class ReadingProgressData extends DataClass
  ...
  @override
  int get hashCode => Object.hash(id, bookId, chapterIndex, pageNumber,
      scrollPosition, progressPercent, readingMinutes, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Tag extends DataClass implements Insertable<Tag> {
  ...
  Tag copyWith({int? id, String? name, int? createdAt}) => Tag(
        id: id ?? this.id,
        name: name ?? this.name,
        createdAt: createdAt ?? this.createdAt,
      );
...
class TagsCompanion extends UpdateCompanion<Tag> {
  ...
  TagsCompanion copyWith(
      {Value<int>? id, Value<String>? name, Value<int>? createdAt}) {
    return TagsCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      createdAt: createdAt ?? this.createdAt,
...
class $HighlightTagsTable extends HighlightTags
    with TableInfo<$HighlightTagsTable, HighlightTag> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $HighlightTagsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _highlightIdMeta =
      const VerificationMeta('highlightId');
  @override
  late final GeneratedColumn<int> highlightId = GeneratedColumn<int>(
  ...
  late final GeneratedColumn<int> tagId = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [highlightId, tagId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'highlight_tags';
  @override
  VerificationContext validateIntegrity(Insertable<HighlightTag> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('highlight_id')) {
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {highlightId, tagId};
  @override
  HighlightTag map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return HighlightTag(
      highlightId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}highlight_id'])!,
  ...
  @override
  $HighlightTagsTable createAlias(String alias) {
    return $HighlightTagsTable(attachedDatabase, alias);
  }
}

class HighlightTag extends DataClass implements Insertable<HighlightTag> {
  /// 高亮 ID（外键）
  final int highlightId;

  /// 标签 ID（外键）
  final int tagId;
  const HighlightTag({required this.highlightId, required this.tagId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['highlight_id'] = Variable<int>(highlightId);
  ...
  HighlightTagsCompanion toCompanion(bool nullToAbsent) {
    return HighlightTagsCompanion(
      highlightId: Value(highlightId),
      tagId: Value(tagId),
    );
  }
  ...
  HighlightTag copyWith({int? highlightId, int? tagId}) => HighlightTag(
        highlightId: highlightId ?? this.highlightId,
        tagId: tagId ?? this.tagId,
      );
  HighlightTag copyWithCompanion(HighlightTagsCompanion data) {
    return HighlightTag(
      highlightId:
          data.highlightId.present ? data.highlightId.value : this.highlightId,
  ...
  @override
  String toString() {
    return (StringBuffer('HighlightTag(')
          ..write('highlightId: $highlightId, ')
          ..write('tagId: $tagId')
          ..write(')'))
        .toString();
  ...
  @override
  int get hashCode => Object.hash(highlightId, tagId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is HighlightTag &&
          other.highlightId == this.highlightId &&
          other.tagId == this.tagId);
}

class HighlightTagsCompanion extends UpdateCompanion<HighlightTag> {
  final Value<int> highlightId;
  final Value<int> tagId;
  final Value<int> rowid;
  const HighlightTagsCompanion({
    this.highlightId = const Value.absent(),
    this.tagId = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  HighlightTagsCompanion.insert({
    required int highlightId,
    required int tagId,
    this.rowid = const Value.absent(),
  })  : highlightId = Value(highlightId),
        tagId = Value(tagId);
  static Insertable<HighlightTag> custom({
    Expression<int>? highlightId,
  ...
  HighlightTagsCompanion copyWith(
      {Value<int>? highlightId, Value<int>? tagId, Value<int>? rowid}) {
    return HighlightTagsCompanion(
      highlightId: highlightId ?? this.highlightId,
      tagId: tagId ?? this.tagId,
  ...
  @override
  String toString() {
    return (StringBuffer('HighlightTagsCompanion(')
          ..write('highlightId: $highlightId, ')
          ..write('tagId: $tagId, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
class $GeneratedPostersTable extends GeneratedPosters
    with TableInfo<$GeneratedPostersTable, GeneratedPoster> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $GeneratedPostersTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'generated_posters';
  @override
  VerificationContext validateIntegrity(Insertable<GeneratedPoster> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  GeneratedPoster map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GeneratedPoster(
      ...
      ratio: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}ratio']),
  ...
  @override
  $GeneratedPostersTable createAlias(String alias) {
    return $GeneratedPostersTable(attachedDatabase, alias);
  }
}

class GeneratedPoster extends DataClass implements Insertable<GeneratedPoster> {
  /// 主键 ID
  final int id;
  ...
  GeneratedPostersCompanion toCompanion(bool nullToAbsent) {
    return GeneratedPostersCompanion(
      id: Value(id),
      highlightId: Value(highlightId),
  ...
  GeneratedPoster copyWithCompanion(GeneratedPostersCompanion data) {
    return GeneratedPoster(
      id: data.id.present ? data.id.value : this.id,
      highlightId:
          data.highlightId.present ? data.highlightId.value : this.highlightId,
  ...
  @override
  String toString() {
    return (StringBuffer('GeneratedPoster(')
          ..write('id: $id, ')
          ..write('highlightId: $highlightId, ')
  ...
  @override
  int get hashCode => Object.hash(id, highlightId, quoteText, bookTitle, author,
      templateKey, ratio, imagePath, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is GeneratedPoster &&
          other.id == this.id &&
          other.highlightId == this.highlightId &&
...
class GeneratedPostersCompanion extends UpdateCompanion<GeneratedPoster> {
  final Value<int> id;
  final Value<int> highlightId;
  ...
  final Value<int> createdAt;
  const GeneratedPostersCompanion({
    this.id = const Value.absent(),
    this.highlightId = const Value.absent(),
  ...
  GeneratedPostersCompanion.insert({
    this.id = const Value.absent(),
    required int highlightId,
    ...
    this.createdAt = const Value.absent(),
        ...
        quoteText = Value(quoteText);
  static Insertable<GeneratedPoster> custom({
    Expression<int>? id,
    Expression<int>? highlightId,
  ...
  GeneratedPostersCompanion copyWith(
      {Value<int>? id,
      Value<int>? highlightId,
  ...
  @override
  String toString() {
    return (StringBuffer('GeneratedPostersCompanion(')
          ..write('id: $id, ')
          ..write('highlightId: $highlightId, ')
          ..write('quoteText: $quoteText, ')
          ..write('bookTitle: $bookTitle, ')
...
class $FavoritesTable extends Favorites
  ...
  late final GeneratedColumn<int> createdAt = GeneratedColumn<int>(
      ...
      defaultValue: const Constant(0));
  @override
  List<GeneratedColumn> get $columns => [id, highlightId, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Favorite extends DataClass implements Insertable<Favorite> {
  ...
  final int createdAt;
  const Favorite(
      {required this.id, required this.highlightId, required this.createdAt});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  Favorite copyWith({int? id, int? highlightId, int? createdAt}) => Favorite(
        id: id ?? this.id,
        highlightId: highlightId ?? this.highlightId,
        createdAt: createdAt ?? this.createdAt,
      );
  ...
  @override
  int get hashCode => Object.hash(id, highlightId, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Favorite &&
...
class FavoritesCompanion extends UpdateCompanion<Favorite> {
  ...
  FavoritesCompanion copyWith(
      {Value<int>? id, Value<int>? highlightId, Value<int>? createdAt}) {
    return FavoritesCompanion(
      id: id ?? this.id,
      highlightId: highlightId ?? this.highlightId,
      createdAt: createdAt ?? this.createdAt,
...
class $CollectionItemsTable extends CollectionItems
  ...
  late final GeneratedColumn<int> highlightId = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [collectionId, highlightId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {collectionId, highlightId};
  @override
...
class CollectionItem extends DataClass implements Insertable<CollectionItem> {
  ...
  /// 高亮 ID（外键）
  final int highlightId;
  const CollectionItem({required this.collectionId, required this.highlightId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  CollectionItem copyWith({int? collectionId, int? highlightId}) =>
      CollectionItem(
  ...
  @override
  int get hashCode => Object.hash(collectionId, highlightId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class CollectionItemsCompanion extends UpdateCompanion<CollectionItem> {
  ...
  CollectionItemsCompanion copyWith(
      {Value<int>? collectionId, Value<int>? highlightId, Value<int>? rowid}) {
    return CollectionItemsCompanion(
      collectionId: collectionId ?? this.collectionId,
      highlightId: highlightId ?? this.highlightId,
      rowid: rowid ?? this.rowid,
...
class $BookmarksTable extends Bookmarks
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, bookId, chapterIndex, pageNumber, note, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Bookmark extends DataClass implements Insertable<Bookmark> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, bookId, chapterIndex, pageNumber, note, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Bookmark &&
...
class SearchHistoryData extends DataClass
  ...
  SearchHistoryData copyWith({int? id, String? keyword, int? createdAt}) =>
      SearchHistoryData(
        id: id ?? this.id,
...
class SearchHistoryCompanion extends UpdateCompanion<SearchHistoryData> {
  ...
  SearchHistoryCompanion copyWith(
      {Value<int>? id, Value<String>? keyword, Value<int>? createdAt}) {
    return SearchHistoryCompanion(
      id: id ?? this.id,
      keyword: keyword ?? this.keyword,
      createdAt: createdAt ?? this.createdAt,
...
class UserSetting extends DataClass implements Insertable<UserSetting> {
  ...
  /// 设置值
  final String? value;
  const UserSetting({required this.key, this.value});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
...
class $PurchaseStatusTable extends PurchaseStatus
    with TableInfo<$PurchaseStatusTable, PurchaseStatusData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $PurchaseStatusTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
      'id', aliasedName, false,
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, productId, purchaseToken, isActive, purchasedAt, expiresAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'purchase_status';
  @override
  VerificationContext validateIntegrity(Insertable<PurchaseStatusData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PurchaseStatusData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $PurchaseStatusTable createAlias(String alias) {
    return $PurchaseStatusTable(attachedDatabase, alias);
  }
}

class PurchaseStatusData extends DataClass
    implements Insertable<PurchaseStatusData> {
  /// 主键 ID
  final int id;
  ...
  PurchaseStatusCompanion toCompanion(bool nullToAbsent) {
    return PurchaseStatusCompanion(
      id: Value(id),
  ...
  factory PurchaseStatusData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return PurchaseStatusData(
      id: serializer.fromJson<int>(json['id']),
  ...
  PurchaseStatusData copyWithCompanion(PurchaseStatusCompanion data) {
    return PurchaseStatusData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('PurchaseStatusData(')
          ..write('id: $id, ')
...
class PurchaseStatusCompanion extends UpdateCompanion<PurchaseStatusData> {
  final Value<int> id;
  ...
  PurchaseStatusCompanion.insert({
    this.id = const Value.absent(),
    this.productId = const Value.absent(),
    this.purchaseToken = const Value.absent(),
    this.isActive = const Value.absent(),
  ...
  static Insertable<PurchaseStatusData> custom({
    Expression<int>? id,
  ...
  PurchaseStatusCompanion copyWith(
      {Value<int>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('PurchaseStatusCompanion(')
          ..write('id: $id, ')
          ..write('productId: $productId, ')
          ..write('purchaseToken: $purchaseToken, ')
          ..write('isActive: $isActive, ')
...
class $AnalyticsEventsTable extends AnalyticsEvents
  ...
  late final GeneratedColumn<int> createdAt = GeneratedColumn<int>(
      ...
      defaultValue: const Constant(0));
  @override
  List<GeneratedColumn> get $columns => [id, eventName, payload, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class AnalyticsEvent extends DataClass implements Insertable<AnalyticsEvent> {
  ...
  @override
  int get hashCode => Object.hash(id, eventName, payload, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class SyncQueueData extends DataClass implements Insertable<SyncQueueData> {
  ...
  @override
  int get hashCode => Object.hash(id, entityType, entityId, action, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class AppMetadataData extends DataClass implements Insertable<AppMetadataData> {
  ...
  const AppMetadataData({required this.metaKey, this.metaValue});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['meta_key'] = Variable<String>(metaKey);
    if (!nullToAbsent || metaValue != null) {
  ...
  AppMetadataCompanion toCompanion(bool nullToAbsent) {
    return AppMetadataCompanion(
      ...
      metaValue: metaValue == null && nullToAbsent
          ? const Value.absent()
          : Value(metaValue),
    );
  }
  ...
  AppMetadataData copyWith(
          {String? metaKey, Value<String?> metaValue = const Value.absent()}) =>
      AppMetadataData(
        metaKey: metaKey ?? this.metaKey,
        metaValue: metaValue.present ? metaValue.value : this.metaValue,
      );
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $HighlightTagsTable highlightTags = $HighlightTagsTable(this);
  late final $GeneratedPostersTable generatedPosters =
      $GeneratedPostersTable(this);
  ...
  late final $PurchaseStatusTable purchaseStatus = $PurchaseStatusTable(this);
...
class $$ReadingProgressTableAnnotationComposer
  ...
  GeneratedColumn<int> get readingMinutes => $composableBuilder(
      column: $table.readingMinutes, builder: (column) => column);
...
class $$NotesTableFilterComposer extends Composer<_$AppDatabase, $NotesTable> {
  ...
  ColumnFilters<int> get highlightId => $composableBuilder(
      column: $table.highlightId, builder: (column) => ColumnFilters(column));
...
class $$NotesTableOrderingComposer
  ...
  ColumnOrderings<int> get highlightId => $composableBuilder(
      column: $table.highlightId, builder: (column) => ColumnOrderings(column));
...
class $$NotesTableAnnotationComposer
  ...
  GeneratedColumn<int> get highlightId => $composableBuilder(
      column: $table.highlightId, builder: (column) => column);
...
typedef $$TagsTableProcessedTableManager = ProcessedTableManager<
    ...
    Tag,
    PrefetchHooks Function()>;
typedef $$HighlightTagsTableCreateCompanionBuilder = HighlightTagsCompanion
    Function({
  required int highlightId,
  required int tagId,
  Value<int> rowid,
});
typedef $$HighlightTagsTableUpdateCompanionBuilder = HighlightTagsCompanion
    Function({
  Value<int> highlightId,
  Value<int> tagId,
  Value<int> rowid,
...
class $$HighlightTagsTableFilterComposer
    extends Composer<_$AppDatabase, $HighlightTagsTable> {
  $$HighlightTagsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$HighlightTagsTableOrderingComposer
    extends Composer<_$AppDatabase, $HighlightTagsTable> {
  $$HighlightTagsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$HighlightTagsTableAnnotationComposer
    extends Composer<_$AppDatabase, $HighlightTagsTable> {
  $$HighlightTagsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$HighlightTagsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $HighlightTagsTable,
    HighlightTag,
    $$HighlightTagsTableFilterComposer,
    $$HighlightTagsTableOrderingComposer,
    $$HighlightTagsTableAnnotationComposer,
    $$HighlightTagsTableCreateCompanionBuilder,
    $$HighlightTagsTableUpdateCompanionBuilder,
    (
      HighlightTag,
      BaseReferences<_$AppDatabase, $HighlightTagsTable, HighlightTag>
    ),
    HighlightTag,
    PrefetchHooks Function()> {
  $$HighlightTagsTableTableManager(_$AppDatabase db, $HighlightTagsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$HighlightTagsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$HighlightTagsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$HighlightTagsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> highlightId = const Value.absent(),
            Value<int> tagId = const Value.absent(),
            Value<int> rowid = const Value.absent(),
          }) =>
              HighlightTagsCompanion(
            highlightId: highlightId,
            tagId: tagId,
            rowid: rowid,
          ),
...
typedef $$HighlightTagsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $HighlightTagsTable,
    HighlightTag,
    $$HighlightTagsTableFilterComposer,
    ...
    HighlightTag,
    PrefetchHooks Function()>;
typedef $$GeneratedPostersTableCreateCompanionBuilder
    = GeneratedPostersCompanion Function({
  Value<int> id,
  required int highlightId,
  required String quoteText,
  Value<String?> bookTitle,
...
typedef $$GeneratedPostersTableUpdateCompanionBuilder
    = GeneratedPostersCompanion Function({
  Value<int> id,
  Value<int> highlightId,
  Value<String> quoteText,
...
class $$GeneratedPostersTableFilterComposer
    extends Composer<_$AppDatabase, $GeneratedPostersTable> {
  $$GeneratedPostersTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GeneratedPostersTableOrderingComposer
    extends Composer<_$AppDatabase, $GeneratedPostersTable> {
  $$GeneratedPostersTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GeneratedPostersTableAnnotationComposer
    extends Composer<_$AppDatabase, $GeneratedPostersTable> {
  $$GeneratedPostersTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$GeneratedPostersTableTableManager extends RootTableManager<
    _$AppDatabase,
    $GeneratedPostersTable,
    GeneratedPoster,
    $$GeneratedPostersTableFilterComposer,
    $$GeneratedPostersTableOrderingComposer,
    $$GeneratedPostersTableAnnotationComposer,
    $$GeneratedPostersTableCreateCompanionBuilder,
    $$GeneratedPostersTableUpdateCompanionBuilder,
    (
      GeneratedPoster,
      BaseReferences<_$AppDatabase, $GeneratedPostersTable, GeneratedPoster>
    ),
    GeneratedPoster,
    PrefetchHooks Function()> {
  $$GeneratedPostersTableTableManager(
      _$AppDatabase db, $GeneratedPostersTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$GeneratedPostersTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$GeneratedPostersTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$GeneratedPostersTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<int> highlightId = const Value.absent(),
...
typedef $$GeneratedPostersTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $GeneratedPostersTable,
    GeneratedPoster,
    $$GeneratedPostersTableFilterComposer,
...
typedef $$UserSettingsTableProcessedTableManager = ProcessedTableManager<
    ...
    UserSetting,
    PrefetchHooks Function()>;
typedef $$PurchaseStatusTableCreateCompanionBuilder = PurchaseStatusCompanion
    Function({
  Value<int> id,
  Value<String?> productId,
  Value<String?> purchaseToken,
...
typedef $$PurchaseStatusTableUpdateCompanionBuilder = PurchaseStatusCompanion
    Function({
  Value<int> id,
  Value<String?> productId,
  Value<String?> purchaseToken,
...
class $$PurchaseStatusTableFilterComposer
    extends Composer<_$AppDatabase, $PurchaseStatusTable> {
  $$PurchaseStatusTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PurchaseStatusTableOrderingComposer
    extends Composer<_$AppDatabase, $PurchaseStatusTable> {
  $$PurchaseStatusTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PurchaseStatusTableAnnotationComposer
    extends Composer<_$AppDatabase, $PurchaseStatusTable> {
  $$PurchaseStatusTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$PurchaseStatusTableTableManager extends RootTableManager<
    _$AppDatabase,
    $PurchaseStatusTable,
    PurchaseStatusData,
    $$PurchaseStatusTableFilterComposer,
    $$PurchaseStatusTableOrderingComposer,
    $$PurchaseStatusTableAnnotationComposer,
    $$PurchaseStatusTableCreateCompanionBuilder,
    $$PurchaseStatusTableUpdateCompanionBuilder,
    (
      PurchaseStatusData,
      BaseReferences<_$AppDatabase, $PurchaseStatusTable, PurchaseStatusData>
    ),
    PurchaseStatusData,
    PrefetchHooks Function()> {
  $$PurchaseStatusTableTableManager(
      _$AppDatabase db, $PurchaseStatusTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$PurchaseStatusTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$PurchaseStatusTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$PurchaseStatusTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> id = const Value.absent(),
            Value<String?> productId = const Value.absent(),
            Value<String?> purchaseToken = const Value.absent(),
...
typedef $$PurchaseStatusTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $PurchaseStatusTable,
    PurchaseStatusData,
    $$PurchaseStatusTableFilterComposer,
...
class $$AnalyticsEventsTableTableManager extends RootTableManager<
  ...
  $$AnalyticsEventsTableTableManager(
      _$AppDatabase db, $AnalyticsEventsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $AppDatabaseManager {
  ...
  $$HighlightTagsTableTableManager get highlightTags =>
      $$HighlightTagsTableTableManager(_db, _db.highlightTags);
  $$GeneratedPostersTableTableManager get generatedPosters =>
      $$GeneratedPostersTableTableManager(_db, _db.generatedPosters);
  ...
  $$PurchaseStatusTableTableManager get purchaseStatus =>
      $$PurchaseStatusTableTableManager(_db, _db.purchaseStatus);
